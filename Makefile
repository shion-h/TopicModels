...
SRC=./src/
INCLUDE=./src/include/
LDA_OBJECT=$(BIN)LDA.o $(BIN)GibbsSamplerFromLDA.o $(BIN)OrdinaryGibbsSamplerFromLDA.o $(BIN)CollapsedGibbsSamplerFromLDA.o $(BIN)BOWFileParser.o
...
LDA_HEADER=$(INCLUDE)GibbsSamplerFromLDA.hpp $(INCLUDE)OrdinaryGibbsSamplerFromLDA.hpp $(INCLUDE)CollapsedGibbsSamplerFromLDA.hpp $(INCLUDE)BOWFileParser.hpp
